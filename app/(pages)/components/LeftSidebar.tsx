  ...
  return (
    <div className="w-fit h-fit  sticky top-20 -left-40">
      ...
      <button
        ...
        className={`${
          isOpen ? "rotate-z-0" : "rotate-z-180"
        } bg-white absolute top-[50%] right-0 w-8 h-8 border-black/40 border-2 rounded-full cursor-pointer grid place-content-center -translate-y-[100%] translate-x-[50%] transition-transform duration-500 hover:bg-gray-100 hover:border-black/60 z-10`}
      >
        <FiChevronRight />
      </button>
